...
def threshold_estimator(
    ...
    #          (curr_mid_idx == end_idx-5 or right_count >= curr_mid_count):
    #      return curr_mid, event_count_diffs
    #  elif (low_thres_idx == curr_mid_idx) or (curr_mid_idx+1 == high_thres_idx):
    #      return curr_mid, event_count_diffs
    #  elif (curr_mid_idx > start_idx and left_count < curr_mid_count):
    #      # if left count is smaller then smaller values on left
    #      #  print("curr range l: {}-{}".format(
    #      #      threshold_range[low_thres_idx],
    #      #      threshold_range[curr_mid_idx]))
    #      return threshold_estimator(
    #          cfg,
    #          low_thres_idx, curr_mid_idx,
    #          threshold_range, event_count_diffs,
    #          ref_event_count)
    #
    #  # if right count is smaller, than smaller values on right
    #  #  print("curr range r: {}-{}".format(
    #  #      threshold_range[curr_mid_idx+1],
    #  #      threshold_range[high_thres_idx]))
    #  return threshold_estimator(
    #      cfg,
    #      curr_mid_idx+1, high_thres_idx,
    #      threshold_range, event_count_diffs,
    #      ref_event_count)
